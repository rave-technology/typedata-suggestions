(function (global, factory) {
  ...
  (global = typeof globalThis !== 'undefined' ? globalThis : global || self, global.typedataSuggestions = factory());
  ...
  function typedataSuggestions(config) {
    var _this = this;
    this.options = config;
    ...
    this.data = {
      src: function src(query) {
        return new Promise(function ($return, $error) {
          ...
          try {
            var source, data;
            return fetch("https://api.typedata.net/v1/suggest/address", {
              method: "POST",
              headers: {
                'Content-Type': 'application/json',
                'Accept': 'application/json',
                'Authorization': "Token ".concat(_this.options.token)
              },
              body: JSON.stringify({
                query: query
              })
              ...
              try {
                source = $await_2;
                return source.json().then(function ($await_3) {
                  try {
                    data = $await_3;
                    return $return(data.suggestions);
                  } catch ($boundEx) {
